# _builtins.py
#
# if you're just browsing you can probably ignore this file although
# it's incredibly useful for me
#
# in my MyNk toolset I've created a menu creation process
# that looks for __menus__ dicts and automagically creates the menus
...
# that aren't part of their own module or library
